...
(defn draw-state [state]
 ...
 (let [xs (state :T-squared) 
       ...
       w (q/width)
       h (q/height)
       x-factor 0.012668122125059987
       ;3.1808722032809875E-5
       ;1.8830121463018065E-6 #_(/ w (- (last xs) (first xs))) 
       y-factor 0.003683987548122087
       ;0.001468849376840652 ;2.373256249970334E-4
      ;7.540767273070035E-6 
      #_(/ h (- (last ys) (first ys)))
       ]
    ; Move origin point to the center of the sketch.
     (draw-axes) 
     (q/fill 255 255 0)
       ; Draw the planet.
       (q/with-translation [0 (- h 10)] ;[10 (- h 10)] [(/ w 2) (/ h 2)]
         (doseq [point points] 
                (q/stroke 0 0 255)
                (q/stroke-weight 10)
